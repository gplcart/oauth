...
use gplcart\modules\oauth\helpers\Jwt as ModuleJwtHelper;
...
class Oauth
{
     ...
     * @param ModuleJwtHelper $jwt
     * @param SessionHelper $session
     * @param UrlHelper $url
     */
    public function __construct(Hook $hook, HttpModel $http, ModuleJwtHelper $jwt,
